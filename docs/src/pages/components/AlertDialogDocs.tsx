...
export function AlertDialogDocs() {
  return (
    <article className="prose prose-neutral dark:prose-invert w-full max-w-none">
      <h1 className="scroll-m-20 text-3xl font-bold tracking-tight">Alert dialog</h1>
      <p className="lead text-lg text-muted-foreground">
        A modal dialog that interrupts the user for important confirmations or acknowledgments.
      </p>
