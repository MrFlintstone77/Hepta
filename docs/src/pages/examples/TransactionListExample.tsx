...
const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  { id: '4', date: '2024-03-05', description: 'Cloud hosting - AWS', category: 'Technology', amount: -312.00, type: 'debit', status: 'completed' },
  ...
  { id: '14', date: '2024-02-29', description: 'Utility bill - Electric', category: 'Utilities', amount: -127.50, type: 'debit', status: 'completed' },
  { id: '15', date: '2024-02-28', description: 'Stock dividend', category: 'Investments', amount: 85.20, type: 'credit', status: 'completed' },
];
  ...
  return (
    <article className="prose prose-neutral dark:prose-invert w-full max-w-none">
      ...
      <p className="lead text-lg text-muted-foreground">
        A sample financial transaction table with filtering, search, and pagination.
      </p>
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>
            View and filter your account activity
          </CardDescription>
      ...
      <DocFooter prev={{ label: 'Overview', href: '/examples' }} />
    </article>
  );
}
